...
sim_stats_file <- "output/simstats/sim_stats_chrom1_chrom5_appended.csv"
sim_params_file <- "priors/priors_2.6.25.csv"
out_dir <- file.path("output", "ABC_results", "rejection_chr5_chr1plus5sim")
figure_dir <- "figures"
...
fwrite(
  posterior_summary,
  file.path(out_dir, paste0("posterior_summary_chr5_chr1plus5sim_rejection_tol001.csv"))
)
fwrite(
  tol_summary,
  file.path(out_dir, paste0("posterior_summary_chr5_chr1plus5sim_rejection_tol_sensitivity.csv"))
)
fwrite(
  post,
  file.path(out_dir, paste0("posterior_samples_chr5_chr1plus5sim_rejection_tol001.csv"))
)
...
ggsave(
  file.path(figure_dir, paste0("posterior_mutation_rates_chr5_chr1plus5sim_rejection_tol001.png")),
  p_mrate,
  width = 7,
  height = 5
)
...
ggsave(
  file.path(figure_dir, paste0("prior_posterior_density_chr5_chr1plus5sim_rejection_tol001.png")),
  final_density_plot,
  width = 12,
  height = 8
)
...
ggsave(
  file.path(figure_dir, paste0("distance_histogram_chr5_chr1plus5sim_rejection_tol001.png")),
  p_dist,
  width = 7,
  height = 5
)
...
ggsave(
  file.path(figure_dir, paste0("ratio_distance_faceted_chr5_chr1plus5sim_rejection_tol001.png")),
  p_ratios,
  width = 7,
  height = 10
)
